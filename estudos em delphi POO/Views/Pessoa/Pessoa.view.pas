...
begin
  ...
  try
    ...
    //Alto acoplamento, é quando uma classe depende
    //de outras classes que dependem de outras clases, util depende de dataUtils.
    //Baixo acoplamento, é quando a dependencia de outras classes é menor,
    //uma classe depende apenas de outra.

    //encadeamento de classes, é um alto acoplamento
    //apenas dependencia de 1 classe é um baixo acoplamento.
